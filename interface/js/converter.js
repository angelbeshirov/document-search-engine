 ...
 */
function checkExclusionWords1(i, currentWord, isUpperCase){
	for (k=0; k<exLen1; k++){
 ...
 * Проверява дали думата съдържа корен, който е имал различно изписване 
 */
function checkExclusionWords2(i, currentWord, isUpperCase){
	for (k=0; k<exLen2; k++){
...
function checkWord(){
	for (i=0; i<wLen; i++){	
		...
		var hasChanged3 = false;
		var hasChanged4 = false;
		var hasChanged5 = false;
		var hasChanged6 = false;
		var hasChanged7 = false;
		var currentWord = words[i].toLowerCase();
		var lastChar = words[i].charAt(words[i].length-1);
		var isUpperCase = (lastChar != lastChar.toLowerCase() && words[i].length>1);
		lastChar = lastChar.toLowerCase();
		var temp = new RegExp("(^\|[ <>\n\r\t.,`„”'\"\+!?()&|~:;{}/\\=-]+)(" + words[i] + ")([ <>\n\r\t.,`„”'\"\+!?()&|~:;{}/\\=-]+\|$)" , "" );
		
		hasChanged1 = checkEnding(i,currentWord, lastChar, isUpperCase);
		hasChanged2 = checkUs(i, currentWord, isUpperCase);
		hasChanged3 = checkYat(i, currentWord, isUpperCase);
		hasChanged4 = checkVS(i, currentWord, isUpperCase);
		hasChanged5 = checkFemaleThe(i, currentWord, isUpperCase);
